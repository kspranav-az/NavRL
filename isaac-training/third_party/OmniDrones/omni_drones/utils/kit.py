...
# Import utilities - try new paths first, fallback to old
try:
...
# Import PhysicsMaterial with proper fallback chain
...
# Import GeometryPrim with proper fallback
GeometryPrim = None
try:
    ...
    try:
        ...
        try:
            ...
            class GeometryPrim:
                def __init__(self, prim_path: str, name: str = "geometry_prim"):
                    self.prim_path = prim_path
                    self.name = name
